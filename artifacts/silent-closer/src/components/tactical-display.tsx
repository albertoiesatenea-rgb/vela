...
export function TacticalDisplay({ signal, sayNow, avoid, isPending }: TacticalDisplayProps) {
  return (
    <div className="h-full w-full flex flex-col">
      ...
      {/* ── SEÑAL ──────────────────────────────────── */}
      <div className="flex flex-col items-center justify-center gap-2 py-6 shrink-0">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 min-h-0">
        <span className="text-[10px] font-mono tracking-[0.3em] text-zinc-700 uppercase mb-6">
          DI AHORA
        </span>
        <AnimatePresence mode="wait">
          <motion.p
