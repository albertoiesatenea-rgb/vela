...
export default function CopilotPage() {
  ...
  const handleModeSwitch = (newMode: Mode) => {
    if (newMode === "simulate" && isListening) {
      stopListening();
    }
    setMode(newMode);
  };
  ...
  return (
    <div className="fixed inset-0 bg-black text-foreground flex flex-col overflow-hidden selection:bg-white/20 font-sans">
      ...
      {/* INTERIM TEXT — what's being heard */}
      ...
      {/* ERROR BANNER — mic not allowed or not supported */}
      {mode === "listen" && speechError && (
